...
exports.createGeminiService = exports.buildResearchPrompt = void 0;
/**
 ...
 */
const buildResearchPrompt = (subject, config) => {
...
const createGeminiService = (resolveEnvValue) => {
     ...
     */
    const performDeepResearch = async (subject, config) => {
        return withRetry(() => fetch(resolveApiUrl('/api/research'), {
            method: 'POST',
            headers: {
     ...
     */
    const findNextInquiry = async (researchSummary) => {
        const data = await withRetry(() => fetch(resolveApiUrl('/api/next-inquiry'), {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
